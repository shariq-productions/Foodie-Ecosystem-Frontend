...
export function     Navbar()  
{
    ...
    return (
        ...
        <div className="flex">            
        <p className="Logo_style" onClick={()=>{router.push("/")}}>Foodie.</p>
        </div>  
        <div className="flex p-4 text-slate-500">
        <Link href="/admin/add" className={menu === 'add' ? 'underline p-2' : 'p-2'} onClick={() => setMenu('add')}>Add item</Link>
        <Link href="/admin/list" className={menu === 'list' ? 'underline p-2' : 'p-2'} onClick={() => setMenu('list')}>List items</Link>
        <Link href="/admin/track" className={menu === 'track' ? 'underline p-2' : 'p-2'} onClick={() => setMenu('track')}>Track orders</Link>
...
<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#000000"><path d="M224.12-161q-49.12 0-83.62-34.42Q106-229.83 106-279H40v-461q0-24 18-42t42-18h579v167h105l136 181v173h-71q0 49.17-34.38 83.58Q780.24-161 731.12-161t-83.62-34.42Q613-229.83 613-279H342q0 49-34.38 83.5t-83.5 34.5Zm-.12-60q24 0 41-17t17-41q0-24-17-41t-41-17q-24 0-41 17t-17 41q0 24 17 41t41 17Zm507 0q24 0 41-17t17-41q0-24-17-41t-41-17q-24 0-41 17t-17 41q0 24 17 41t41 17Zm-52-204h186L754-573h-75v148Z"/>
        ...
        <div className="Button_style"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#434343"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z"/></svg></div>
        </ul>
        </div>
        </>
    )
